...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2024 at 07:27 PM
...
CREATE TABLE `additional_considerations` (
  ...
  `missingVaccine` varchar(255) DEFAULT NULL,
  `anyMissingVaccines` varchar(255) DEFAULT NULL,
  `mentalDisorder` varchar(255) DEFAULT NULL,
...
(6, 12, 'Dilia', 'Suriel', 'NYC, NY', '6027986541', 0, 'dilia@appliedinsightinc.com', 'yes', 'yes', 'yes', 'needHelpFilling'),
(7, 13, 'Diana', 'Rockwell', 'Phoenix, AZ', '6023997645', 0, 'dsuriel1218@gmail.com', 'yes', 'yes', 'yes', 'fillYourself');
...
--
ALTER TABLE `address`
  MODIFY `AddressID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `encounter`
  MODIFY `EncounterID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `marriage`
  MODIFY `MarriageID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `offspring`
--
ALTER TABLE `offspring`
  MODIFY `OffspringID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `residency_documents`
  MODIFY `DocumentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;

--
-- AUTO_INCREMENT for table `screen`
--
ALTER TABLE `screen`
  MODIFY `screen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `verification_attempts`
  MODIFY `AttemptID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `verification_codes`
--
ALTER TABLE `verification_codes`
  MODIFY `CodeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
